...
class _RateBookingPageState extends State<RateBookingPage> {
  ...
  final List<String> _availableTags = ['Friendly', 'Professional', 'Knowledgeable', 'Punctual', 'Great Tips'];
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const Text('What stood out?', style: TextStyle(fontWeight: FontWeight.bold)),
