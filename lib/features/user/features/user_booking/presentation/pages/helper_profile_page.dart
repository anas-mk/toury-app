  ...
  Widget build(BuildContext context) {
    ...
    if (_error != null || _helper == null) {
      return Scaffold(
        appBar: AppBar(),
        body: AppErrorState(
          title: 'Unable to load helper',
          message: _error ?? 'Helper not found.',
          onRetry: _fetchHelper,
        ),
      );
    }
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                if (helper.suitabilityReasons != null &&
                    helper.suitabilityReasons!.isNotEmpty) ...[
                  const SizedBox(height: AppTheme.spaceXL),
                  Text(
                    'Why this helper?',
                    style: theme.textTheme.titleMedium?.copyWith(
                ...
                Row(
                  ...
                  children: [
                    _buildStat(
                      ...
                      '${(helper.acceptanceRate * 100).toInt()}%',
                      'Acceptance',
                    ),
                    _buildStat(
                      theme,
                      Icons.check_circle_rounded,
                      '${helper.completedTrips}',
                      'Trips',
                    ),
                    _buildStat(
                      theme,
